...
// http://dimsemenov.com/private/home.php?build=bullets_fullscreen_autoplay_auto-height 
// jquery.royalslider v9.5.7
(function(n) {
    function v(b, f) {
        ...
        c ? k("pointer", "down", "move", "up", 
        "cancel") : k("MSPointer", "Down", "Move", "Up", "Cancel")) : (a.isIOS ? a._j1 = a._k1 = a._l1 = a._m1 = "" : k("mouse", "down", "move", "up"),
        ...
        a._h1 = "-moz-grabbing") : h.webkit && -1 != e.platform.indexOf("Mac") && (a._g1 = 
        "-webkit-grab",
    ...
    v.prototype = {
        ...
        _i1: function() {
            ...
            this._e1.css("cursor", this._g1) : (this._e1.removeClass("grabbing-cursor"),
        ...
        _f2: function() {
            ...
            this._d2.css("display", "none")) : (this._c2.css("display", 
            "block"),
